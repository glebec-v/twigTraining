...
$content->one = 'Save the complicated maneuvers for outside the ship: every part of a 300 Series spacecraft is exactly
...
$content->two = 'You’re traveling at thousands of kilometers per hour, blasting asteroids with your laser cannons and
...
$content->three = 'Why wouldn’t you want the best? Here at ORIGIN, we understand that every-one is different so our
...
$content->four = 'Peace of mind doesn’t have to mean losing out on a piece of the action. A professional pilot can’t
...
switch($request){
    case '/':
    case '/home':
        echo $twig->render('homepage.html', ['content' => $content]);
        break;
    case '/about':
        echo $twig->render('about.html', [
            'pic' => '/views/pics/350r_about.jpg',
            'text' => 'If it is possible for a company to merge class and sophistication with the sheer risk of
